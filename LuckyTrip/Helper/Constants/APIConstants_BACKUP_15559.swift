...
<<<<<<< HEAD
    ...
    case plan =  "plan"
    case faq = "faq"
    case currentSubscribe = "subscriptions-active"
    case endSubscribe = "subscriptions-terminated"
    case reasonCancelSubscribe = "unsubscribe-reason"
    case cancelSubscribe = "cancel-subscriptions"
=======
    case interestCategories = "categories/all"
    case addInterests = "user/add-interests"
    case getSeriesCategories = "genres"
    
>>>>>>> 680ec646c04de1a2ea5cd1e7c2d466f0c6738832
}
